...
function MiniUI:new(cusTitle)
    ...
    local function showNextNotification()
        if #notificationQueue > 0 and not currentNotification then
            ...
            c("UIStroke", {Color = Color3.fromRGB(60, 60, 60), Thickness = 2, Parent = notif})
    ...
    spawn(function()
        ...
        serverSub:Img("https://www.roblox.com/headshot-thumbnail/image?userId=" .. game.Players.LocalPlayer.UserId .. "&width=420&height=420&format=png")
